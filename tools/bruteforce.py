    ...
    while True:
        ...
        for port_info in open_ports:
            ...
            if input(f"Lancer Hydra pour ce service ? (o/n) : ").lower() == 'o':
                chemin_utilisateurs = input("Chemin des utilisateurs (laissez vide pour le dictionnaire par défaut /usr/share/wordlists/rockyou2.txt) : ") or "/usr/share/wordlists/rockyou2.txt"
                chemin_mots_de_passe = input("Chemin des mots de passe (laissez vide pour le dictionnaire par défaut /usr/share/wordlists/rockyou2.txt) : ") or "/usr/share/wordlists/rockyou2.txt"
