...
class SafetyTests(unittest.TestCase):
    ...
    def test_web_layout_escapes_title(self):
        ...
        self.assertIn("CARTO Dark Matter", page)
        self.assertIn("MapLibre 3D plongeante", page)
        self.assertIn("map-mode-cycle", page)
        self.assertIn("cycleMapMode", page)
        self.assertNotIn("Vue hologramme locale", page)
        self.assertNotIn("Vue SOC flux", page)
        self.assertNotIn("CARTO Voyager", page)
        self.assertIn("[name=glass_opacity]", page)
        self.assertIn("[name=app_color_mode]", page)
        self.assertNotIn("[name=map_color_mode]", page)
        self.assertIn("mode-track", page)
        self.assertIn("page-actions", page)
        self.assertIn("result-modal", page)
        self.assertIn("dashboard-board", page)
        self.assertNotIn("data-dashboard-edit", page)
        self.assertNotIn("data-size-cycle", page)
        self.assertNotIn("data-layout-action", page)
        self.assertNotIn("data-dashboard-reset", page)
        self.assertIn('data-mode-track="app"', page)
        self.assertNotIn('data-mode-track="map"', page)
        self.assertIn("demotiles.maplibre.org", page)
